 ...
 * @semaphore - глобальный параметр, чтобы в приложении одновременно могло работать только два потока
 */
public class Table {
    ...
    /**
     * Метод инициализации, "рассаживаем философов за стол и раскладываем вилки
     * между ними"
     */
    private void init() {
        // forks init
